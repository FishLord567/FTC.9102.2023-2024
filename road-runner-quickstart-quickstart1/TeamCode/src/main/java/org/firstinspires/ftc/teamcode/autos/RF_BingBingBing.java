...
@Autonomous
public class RF_BingBingBing extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence trajSeqL = drive.trajectorySequenceBuilder(startPose) //TODO:
                ...
                .splineToConstantHeading(new Vector2d(-29, -12), Math.toRadians(0))
                ...
                .splineToConstantHeading(new Vector2d(51, -30.5), Math.toRadians(0))
                .addTemporalMarker(9, () -> {
                ...
                .splineToSplineHeading(new Pose2d(24, -16, Math.toRadians(180.1)), Math.toRadians(180))
                .addDisplacementMarker(() -> {
                    m_clawSubsystem.setClawOpen();
                })
                .splineToConstantHeading(new Vector2d(-57, -16), Math.toRadians(180))
                ...
                .waitSeconds(1)
                .lineToConstantHeading(new Vector2d(24, -16))
                .addDisplacementMarker(() -> {
                ...
                .splineToSplineHeading(new Pose2d(52, -36, Math.toRadians(.2)), Math.toRadians(0))
        ...
        TrajectorySequence trajSeqM = drive.trajectorySequenceBuilder(startPose) //TODO:
                ...
                .splineToConstantHeading(new Vector2d(49, -37.5), Math.toRadians(0))
        ...
        TrajectorySequence trajSeqR = drive.trajectorySequenceBuilder(startPose) //TODO:
                ...
                .lineToConstantHeading(new Vector2d(-30, -38))
                ...
                .splineToConstantHeading(new Vector2d(51.5, -44), Math.toRadians(0))
                ...
                .splineToSplineHeading(new Pose2d(24, -15.5, Math.toRadians(180.1)), Math.toRadians(180))
                .addDisplacementMarker(() -> {
                    m_clawSubsystem.setClawOpen();
                })
                .splineToConstantHeading(new Vector2d(-55, -15.5), Math.toRadians(180))
                ...
                .waitSeconds(1)
                .lineToConstantHeading(new Vector2d(24, -16.25))
                .addDisplacementMarker(() -> {
        ...
        TrajectorySequence trajSeqE = drive.trajectorySequenceBuilder(startPose)
                .addDisplacementMarker(() -> {
                    m_armSubsystem.resetArmEncoders();
                    m_armSubsystem.setArmAngleByTick(-Constants.ARM_INIT_TICK);
                })
    ...
    static class rectangle_thresholder_pipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            Core.inRange(hsvMat, Constants.lowerR, Constants.upperR, binaryMat);
